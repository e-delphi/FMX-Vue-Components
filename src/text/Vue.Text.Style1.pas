...
function TVueTextStyle1.GetText: String;
begin
  Result := edtText.Text;
end;

procedure TVueTextStyle1.SetText(const Value: String);
begin
  edtText.Text := Value;
end;

function TVueTextStyle1.GetFocusColor: TAlphaColor;
begin
  Result := lbColorAni.StopValue;
end;

procedure TVueTextStyle1.SetFocusColor(const Value: TAlphaColor);
begin
